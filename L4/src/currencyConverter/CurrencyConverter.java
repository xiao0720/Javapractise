...
public class CurrencyConverter {
	...
	private int converter(String currentCurrency, double amount){
	...
	private void initialize() {
		...
		jComboBoxCurrency.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//currentCurrency = (String)e.getSelectedItem();
				currentCurrency = (String)jComboBoxCurrency.getSelectedItem(); //feature of JComboBox
			}
		});
